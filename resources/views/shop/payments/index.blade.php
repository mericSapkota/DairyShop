...
<div class="flex flex-col gap-4">
  ...
  <div class="container px-10 mx-auto w-max">
    <div class="flex flex-col w-80 gap-4">
      ...
      <div>
        <form class="flex flex-col gap-4" action="/payment/{{$order->id}}" method="post" enctype="multipart/form-data">
          @csrf
          @method('post')
          <label for="name">Name</label>
          <input type="text" name="name" placeholder="Enter your Name" value="{{$order->user->name}}">
